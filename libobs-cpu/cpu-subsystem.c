...
void device_enter_context(gs_device_t *device) { UNIMPLEMENTED }
void device_leave_context(gs_device_t *device) { UNIMPLEMENTED }
...
gs_samplerstate_t *device_samplerstate_create(gs_device_t *device, const struct gs_sampler_info *info) { UNIMPLEMENTED_RET(NULL) }
...
enum gs_texture_type device_get_texture_type(const gs_texture_t *texture) { UNIMPLEMENTED_RET(GS_TEXTURE_2D) }
...
void device_load_vertexshader(gs_device_t *device, gs_shader_t *vertshader) { UNIMPLEMENTED }
void device_load_pixelshader(gs_device_t *device, gs_shader_t *pixelshader) { UNIMPLEMENTED }
...
void device_set_render_target(gs_device_t *device, gs_texture_t *tex, gs_zstencil_t *zstencil) { UNIMPLEMENTED }
...
void device_begin_frame(gs_device_t *device) { UNIMPLEMENTED }
void device_begin_scene(gs_device_t *device) { UNIMPLEMENTED }
void device_draw(gs_device_t *device, enum gs_draw_mode draw_mode, uint32_t start_vert, uint32_t num_verts) { UNIMPLEMENTED }
void device_end_scene(gs_device_t *device) { UNIMPLEMENTED }
void device_clear(gs_device_t *device, uint32_t clear_flags, const struct vec4 *color, float depth, uint8_t stencil) { UNIMPLEMENTED }
void device_flush(gs_device_t *device) { UNIMPLEMENTED }
void device_set_cull_mode(gs_device_t *device, enum gs_cull_mode mode) { UNIMPLEMENTED }
enum gs_cull_mode device_get_cull_mode(const gs_device_t *device) { UNIMPLEMENTED_RET(GS_BACK) }
void device_enable_blending(gs_device_t *device, bool enable) { UNIMPLEMENTED }
void device_enable_depth_test(gs_device_t *device, bool enable) { UNIMPLEMENTED }
...
void device_blend_function_separate(gs_device_t *device, enum gs_blend_type src_c, enum gs_blend_type dest_c, enum gs_blend_type src_a, enum gs_blend_type dest_a) { UNIMPLEMENTED }
...
void device_set_viewport(gs_device_t *device, int x, int y, int width, int height) { UNIMPLEMENTED }
...
void device_ortho(gs_device_t *device, float left, float right, float top, float bottom, float near, float far) { UNIMPLEMENTED }
...
gs_texture_t *device_texture_create(gs_device_t *device, uint32_t width, uint32_t height, enum gs_color_format color_format,
...
gs_stagesurf_t *device_stagesurface_create(gs_device_t *device, uint32_t width, uint32_t height, enum gs_color_format color_format) { UNIMPLEMENTED_RET(NULL) }
gs_shader_t *device_vertexshader_create(gs_device_t *device, const char *shader, const char *file, char **error_string) { UNIMPLEMENTED_RET(NULL) }
gs_shader_t *device_pixelshader_create(gs_device_t *device, const char *shader, const char *file, char **error_string) { UNIMPLEMENTED_RET(NULL) }
gs_vertbuffer_t *device_vertexbuffer_create(gs_device_t *device, struct gs_vb_data *data, uint32_t flags) { UNIMPLEMENTED_RET(NULL) }
...
void device_load_vertexbuffer(gs_device_t *device, gs_vertbuffer_t *vb) { UNIMPLEMENTED }
void device_load_indexbuffer(gs_device_t *device, gs_indexbuffer_t *ib) { UNIMPLEMENTED }
